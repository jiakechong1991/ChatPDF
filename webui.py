...
if __name__ == '__main__':
    ...
    parser.add_argument("--gen_model_name", type=str, default="/home/wangxk/project/model_bin_common/Qwen2-7B-Instruct")
    ...
    parser.add_argument("--server_port", type=int, default=8083)
